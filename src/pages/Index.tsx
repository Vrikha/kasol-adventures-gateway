...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50/80 via-white/90 to-amber-100/80 relative">
      ...
      {/* Floating Header */}
      <header className="fixed top-4 left-4 right-4 bg-white/95 backdrop-blur-lg border border-yellow-200/50 rounded-2xl shadow-xl z-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 pt-20">
          ...
          <p className="text-xl md:text-2xl mb-12 text-yellow-100 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button
              ...
              className="bg-gradient-to-r from-yellow-600 to-amber-700 hover:from-yellow-700 hover:to-amber-800 text-white px-10 py-6 text-lg rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300 border-0"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="text-center bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-6 shadow-xl">
              ...
              <div className="text-sm text-yellow-100">Happy Travelers</div>
            </div>
            <div className="text-center bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-6 shadow-xl">
              <div className="text-3xl font-bold text-amber-300 mb-2">50+</div>
              <div className="text-sm text-yellow-100">Scenic Locations</div>
            </div>
            <div className="text-center bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-6 shadow-xl">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-20">
            <div className="inline-flex items-center space-x-2 bg-yellow-100/80 backdrop-blur-sm border border-yellow-200 rounded-full px-6 py-3 mb-6">
              ...
              <span className="text-sm font-medium text-yellow-800">Premium Services</span>
            </div>
      ...
      {/* Contact Section */}
      <section className="py-24 bg-gradient-to-r from-yellow-800/90 to-amber-900/90 text-white relative overflow-hidden">
        <div 
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-yellow-900/95 to-amber-900/95"></div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-yellow-100">+91 {whatsappNumber}</p>
            </div>
            <div className="bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-8 shadow-xl">
              <Mail className="h-8 w-8 text-amber-300 mx-auto mb-4" />
              <h4 className="font-semibold mb-2">Email Us</h4>
              <p className="text-yellow-100 break-all">{emailAddress}</p>
            </div>
            <div className="bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-8 shadow-xl">
              <MapPin className="h-8 w-8 text-yellow-300 mx-auto mb-4" />
              <h4 className="font-semibold mb-2">Visit Us</h4>
              <p className="text-yellow-100">Kasol, Parvati Valley</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-white/80 backdrop-blur-md border-t border-yellow-200/50 text-gray-800 py-12">
